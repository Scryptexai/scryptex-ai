  ...
  return (
    <section className="section-padding relative overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        {/* Logo */}
        <div className="flex justify-center lg:justify-start mb-4 my-0 px-0 mx-0 rounded">
          <img
            alt="Scryptex Logo"
            src="media/logo.png"
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex justify-center lg:justify-start">
              <a href="https://tally.so/r/npZvNE" target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="bg-[#3366FF] hover:bg-[#3366FF]/90 transition-colors duration-200">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <p className="text-gray-600 mb-6">
                Access the power of AI research right from your Telegram app. Analyze projects, track airdrops, and never miss an opportunity.
              </p>
