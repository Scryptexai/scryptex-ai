        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 flex justify-center lg:justify-end fade-in">
            <div className="relative w-full max-w-[400px]">
              {/* Hero image */}
              <img src="/lovable-uploads/862e4806-f7e8-408a-aaec-acf47b417eab.png" alt="Scryptex AI Assistant" className="w-full h-auto object-contain drop-shadow-xl float" />
            </div>
          </div>
        </div>
